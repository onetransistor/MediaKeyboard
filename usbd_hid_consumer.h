...
#ifndef __USB_HID_CONSUMER_H
#define __USB_HID_CONSUMER_H
...
// endpoints are redefind in this header
...
/* HID composite (Consumer + Keyboard) Endpoints Configurations */
#define HID_CONSUMER_EPIN_ADDR        0x81U
#define HID_KEYBOARD_EPIN_ADDR        0x82U

#define HID_CONSUMER_EPIN_SIZE        0x03U
...
typedef struct {
  ...
  uint32_t             IdleState;
  uint32_t             AltSetting;
  HID_StateTypeDef     Consumerstate;
